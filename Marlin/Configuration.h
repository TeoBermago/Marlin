...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  18.96,  18.96 }
    #define DEFAULT_Ki_LIST {   1.35,   1.35 }
    #define DEFAULT_Kd_LIST {  66.73,  66.73 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 75.14
  #define DEFAULT_bedKi 4.68
  #define DEFAULT_bedKd 56.49
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.00, 80.00, 400, 409.61 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -8, -3.66 }
